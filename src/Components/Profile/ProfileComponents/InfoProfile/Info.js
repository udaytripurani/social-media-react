...
const Info = ({userPostData,
  ...
  const handleLogout = () => {
    // Perform a GET request here to log the user out.
    fetch('https://rushsocial.auth.us-east-1.amazoncognito.com/logout?client_id=37o9hr7hjv3ojqcbc7b9r2egbd&logout_uri=http%3A%2F%2Flocalhost%3A3000%2FSocial-Media-App-Frontend%2Flogout', {
      method: 'GET',
    })
      .then((response) => {
